...
export default function VaporizeTextCycle({
  ...
  }, [wrapperRef.current, texts, font, color, alignment, globalDpr, currentTextIndex, transformedDensity]); 
...
const renderCanvas = ({
  ...
  const { particles, textBoundaries } = createParticles(ctx, canvas, currentText, textX, textY, font, color, framerProps.alignment || "left", transformedDensity);
...
const createParticles = (
  ...
  const sampleRate = Math.max(1, Math.round(1 / density));
