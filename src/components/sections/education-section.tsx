...
const timelineData: TimelineItem[] = [
  {
    ...
    institutionOrEvent: 'Vishnu Institute of Technology',
    date: '2024 - 2027',
    description: 'Focused on software engineering, data structures, algorithms, and AI. Dean\'s List for 4 semesters.',
  },
  {
    type: 'achievement',
    title: 'Winner, National Hackathon 2023',
    institutionOrEvent: 'Tech Innovators Inc.',
    date: 'March 2023',
    description: 'Led a team to develop an award-winning project focusing on sustainable technology solutions using AI.',
  },
  {
    type: 'education',
    title: 'Web Development Bootcamp',
    institutionOrEvent: 'Code Academy Pro',
    date: 'Summer 2022',
  ...
  },
  {
    ...
    institutionOrEvent: 'International Conference on AI',
    date: 'October 2023',
    description: 'Co-authored a paper on novel approaches to natural language processing, presented at a renowned conference.',
  },
];
